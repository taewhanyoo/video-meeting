...
app.get('/user-link',(req, res)=>{
    ...
    // res.send('https://192.168.55.8:3000/join-video?token='+token);
    res.send('https://www.yoo.homes/join-video?token='+token);
...
app.get('/pro-link',(req, res)=>{
    ...
    // res.send(`<a href="https://192.168.55.8:3000/dashboard?token=${token}" target="_blank">Link Here</a>`);
    res.send(`<a href="https://www.yoo.homes/dashboard?token=${token}" target="_blank">Link Here</a>`);
})
